      ...
      <div className="flex min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-md space-y-8">
          <div className="mb-4 text-sm ">
            Demi keamanan, silahkan konfirmasi password kamu sebelum lanjut memakai Cuy.
          </div>
          <div>
            <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">Daftar Cuy</h2>
